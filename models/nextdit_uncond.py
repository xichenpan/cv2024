...
class NextDiTUncondConfig(PretrainedConfig):
    model_type = "nextdit_uncond"
    ...
    def __init__(
        ...
        norm_eps: float = 1e-5,
        latent_embedding_size: int = 2048,
...
class NextDiTUncond(PreTrainedModel):
    config_class = NextDiTUncondConfig

    def __init__(
        self,
        config: NextDiTUncondConfig,
    ) -> None:
        ...
        self.freqs_cis = NextDiTUncond.precompute_freqs_cis(
    ...
    def forward(self, x, timestep, **kwargs):
        ...
        adaln_input = self.t_embedder(timestep)  # (N, D)
